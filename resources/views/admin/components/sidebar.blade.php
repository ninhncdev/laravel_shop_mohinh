        ...
        <div class="container-fluid">
            ...
            <ul
                ...
                <li class="nav-item">
                    ...
                    >
                        <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Quản lí người dùng</span>
                    </a>
                ...
                <li class="nav-item">
                    ...
                    >
                        <i class="ri-apps-2-line"></i> <span data-key="t-dashboards">Quản lí danh mục</span>
                    </a>
                ...
                <li class="nav-item">
                    ...
                    >
                        <i class="ri-apps-2-line"></i> <span data-key="t-dashboards">Quản lí sản phẩm</span>
                    </a>
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a
                                    ...
                                    class="nav-link"> <span data-key="t-file-manager">File Manager</span></a>
                            </li>
                            <li class="nav-item">
                                <a
                                    href="apps-todo.html"
                                    class="nav-link"> <span data-key="t-to-do">To Do</span></a>
                            </li>
                            <li class="nav-item">
                                <a
                                    href="#sidebarjobs"
