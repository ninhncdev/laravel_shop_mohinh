...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Đăng nhâp | Shop - Admin & Dashboard Template</title>
    <meta
        name="viewport"
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-6">
                                <div class="p-lg-5 p-4">
                                    <div>
                                        <h5 class="text-primary">Chào mừng đã đến trang web !</h5>
                                        <p class="text-muted">Vui lòng đăng nhập tài khoản.</p>
                                    </div>

                                    <div class="mt-4">
                                        <form
                                            action="{{route('postLoginAdmin')}}"
                                            method="post">
                                            @csrf
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="mb-0">Don't have an account ? <a
                                                href="{{route('register')}}"
                                                class="fw-semibold text-primary text-decoration-underline"> Đăng kí</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
