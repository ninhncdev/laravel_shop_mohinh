...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Đăng kí | Shop - Admin & Dashboard Template</title>
    <meta
        name="viewport"
                        ...
                        <div class="row justify-content-center g-0">
                            ...
                            <div class="col-lg-6">
                                <div class="p-lg-5 p-4">
                                    ...
                                    @endif
                                    <div>
                                        <h5 class="text-primary">Đăng kí tài khoản người dùng</h5>
                                    </div>
                                    <div class="mt-4">
                                        <form
                                            ...
                                            <div class="mb-3">
                                                ...
                                                >
                                                @error('email')
                                                <div class="mt-2 text-warning italic">
                                                    Vui lòng nhập email!
                                                </div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mt-4 text-center">
                                                <div class="signin-other-title">
                                                    <h5 class="fs-13 mb-4 title text-muted">Tạo tài khoản bằng</h5>
                                                </div>
